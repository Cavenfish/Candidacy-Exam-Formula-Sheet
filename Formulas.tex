...
$[x_i, F(p)] = i \hbar \frac{\partial F(p)}{\partial p_i}$
\hspace*{1cm}
$[p_i, G(x)] = -i \hbar \frac{\partial G(x)}{\partial x_i}$

Heisenberg picture:
$\frac{d}{dt} \hat{A}(t) = \frac{i}{\hbar}[\hat{H}, \hat{A}(t)] + \frac{\partial \hat{A}}{\partial t}$

Probability (particle) current:
$j = \frac{\hbar}{2mi} (\psi^* \nabla\psi + \psi\nabla\psi^*)$
...
$(\Delta \hat{x})^2 = \frac{\hbar}{m\omega} (n + \frac{1}{2})$
\hspace*{1cm}
$(\Delta \hat{p})^2 = \hbar m\omega (n + \frac{1}{2})$
...
$p(x,E_n) = \sqrt{2m(E_n - V(x))}$

For 0 rigid walls:
$\chi = \hbar(n + \frac{1}{2})$

For 1 rigid wall:
$\chi = \pi \hbar (n + \frac{3}{4})$
...
$E_n^{(1)} = \bra{\psi_n^{(0)}}\hat{H}_p\ket{\psi_n^{(0)}}$
...
$\braket{r} = \int_0^{\infty} r P(r) dr$
\hspace*{1cm}
$P(r) = r^2 |R_{n,\ell}(r)|^2$

$\bra{n,\ell}r\ket{n,\ell} = \frac{1}{2}[3n^2 - \ell(\ell+1)]a_{\circ}$

$\bra{n,\ell}r^2\ket{n,\ell} = \frac{1}{2}n^2[5n^2 + 1 - 3\ell(\ell+1)]a_{\circ}^2$

$\bra{n,\ell}r^{-1}\ket{n,\ell} = \frac{1}{n^2a_{\circ}}$

$\bra{n,\ell}r^{-2}\ket{n,\ell} = \frac{2}{n^3(2\ell + 1)a_{\circ}^2}$
\hspace*{0.8cm}
Bhor radius:
$a_{\circ} = \frac{4\pi \epsilon_{\circ}\hbar^2}{m_e e^2}$
